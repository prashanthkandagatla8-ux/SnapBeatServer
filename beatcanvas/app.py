...
def render_mobile(
    ...
    title_font: str = Form("great_vibes"),
    title_font_size: str = Form("large"),
    title_style: str = Form("classic"),
    title_frame: str = Form("none"),
    title_audio: str = Form("before_audio"),
    ...
    options = {
        ...
        "title_font_size": (title_font_size or "large").lower().strip(),
        "title_style": (title_style or "classic").lower().strip(),
        "title_frame": (title_frame or "none").lower().strip(),
        "title_audio": (title_audio or "before_audio").lower().strip(),
